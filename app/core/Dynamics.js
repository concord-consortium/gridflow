...
module.exports.prototype.update = function (elapsed) {
  ...
  this.gameState.globals.supply[0].wind = this.gameState.globals.supply[0].wind * 0.8 + this.baseSupply[0] * 0.2 + Math.random() * 0.1;
  this.gameState.globals.supply[1].solar = this.baseSupply[1] * (cycle * 0.5 + 0.5);
  this.gameState.globals.supply[2].fossil = this.gameState.globals.supply[2].fossil * 0.9 + this.baseSupply[2] * 0.1 + Math.random() * 0.05;
  this.gameState.globals.supply[3].solar = this.baseSupply[3] * (cycle * 0.5 + 0.5);
